...
$i++;
$cfg['Servers'][$i]['host'] 			= 'scamazprev-71472095b29a4ade985ae69a395b9b91-dbserver.mysql.database.azure.com';
$cfg['Servers'][$i]['port'] 			= '';
$cfg['Servers'][$i]['connect_type'] 	= 'tcp';
$cfg['Servers'][$i]['socket'] 			= '';
$cfg['Servers'][$i]['AllowNoPassword']	= false;   // true/false
$cfg['blowfish_secret']					= '(?S9Rn!,]zu!R~MzZ8yBH?)Bx_A#tf]F' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_knThNsMcE2P1SHzr4RJKqim/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
...
$cfg['Servers'][$i]['SignonURL']    = 'https://scamazpreventionau.azurewebsites.net/wp-admin/?rand=32299077&goto_wp_phpmyadmin=1';
$cfg['Servers'][$i]['LogoutURL']    = 'https://scamazpreventionau.azurewebsites.net/wp-admin/?rand=23055807&pma_logout=1';

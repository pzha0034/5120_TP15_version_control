...
class WPDA_Table_Actions
{
    ...
    public function tab_settings()
    {
        ...
        $settings_table_form = '<form' . " id='" . $settings_table_form_id . "'" . " action='?page=" . esc_attr( \WP_Data_Access_Admin::PAGE_MAIN ) . "'" . " method='post'>" . "<input type='hidden' name='action' value='settings-table' />" . "<input type='hidden' name='settings_table_name' value='" . $this->table_name . "' />" . "<input type='hidden' name='settings' id='" . esc_attr( $settings_table_form_settings ) . "' value='' />" . "<input type='hidden' name='_wpnonce' value='" . esc_attr( $wp_nonce_settings ) . "' />" . '</form>';
        ...
        $delete_menu_table_form_id = 'delete_menu_table_form_' . $this->table_name;
        $delete_menu_table_form = '<form' . " id='" . $delete_menu_table_form_id . "'" . " action='?page=" . esc_attr( \WP_Data_Access_Admin::PAGE_MAIN ) . "'" . " method='post'>" . "<input type='hidden' name='action' value='delete-menu' />" . "<input type='hidden' name='menu_id' id='" . esc_attr( $this->rownum ) . "_menu_id' value='' />" . "<input type='hidden' name='menu_table_name' value='" . $this->table_name . "' />" . "<input type='hidden' name='_wpnonce' value='" . esc_attr( $wp_nonce_delete_menu ) . "' />" . '</form>';
        ...
        echo  $settings_table_form ;
        // phpcs:ignore WordPress.Security.EscapeOutput
        ?>");
							jQuery("#wpda_invisible_container").append("<?php 
        echo  $delete_menu_table_form ;
        // phpcs:ignore WordPress.Security.EscapeOutput
        ?>");
						</script>
        ...
        ?>">
							<div style="font-weight:bold; padding-bottom:10px;">
								...
								<span style="vertical-align:middle">
									<?php 
        echo  __( 'Please note that these settings only work within in the plugin', 'wp-data-access' ) ;
        ?>
								</span>
							</div>
        ...
        ?>
								<li>
									<span class="wpda_table_settings_caret"><?php 
        ...
        ?></span>
									<a href="https://wpdataaccess.com/docs/documentation/data-explorer/table-settings/" target="_blank">
										<span class="dashicons dashicons-editor-help wpda_tooltip"
											  title="<?php 
        echo  __( 'Define table settings [help opens in a new tab or window]', 'wp-data-access' ) ;
        ?>"
...
Start with high values and work down until the error disappears." style="cursor:pointer;vertical-align:middle"></span>
        ...
        ?></span>
									<a href="https://wpdataaccess.com/docs/documentation/data-explorer/column-settings/" target="_blank">
										<span class="dashicons dashicons-editor-help wpda_tooltip"
											  title="<?php 
        echo  __( 'Define column labels and (media) types [help opens in a new tab or window]', 'wp-data-access' ) ;
        ?>"
											  style="cursor:pointer"></span>
									</a>
									<ul class="wpda_table_settings_nested">
										<table class="wpda_table_settings">
											<tr>
												<th style="padding-left:0;vertical-align:bottom;"><?php 
        ...
        ?></span>
									<a href="https://wpdataaccess.com/docs/documentation/data-explorer/dynamic-hyperlinks/" target="_blank">
										<span class="dashicons dashicons-editor-help wpda_tooltip"
											  title="<?php 
        echo  sprintf( __( 'Add dynamic hyperlinks to table `%s` [help opens in a new tab or window]', 'wp-data-access' ), esc_attr( $this->table_name ) ) ;
        ?>"
											  style="cursor:pointer"></span>
									</a>
									<ul class="wpda_table_settings_nested">
										<table class="wpda_table_settings">
											<tr>
												<th style="padding-left:0;">
													<span style="vertical-align:bottom;"><?php 
...
Variable $$column_name$$ will be replaced with the value of column $$column_name$$ in table `' . esc_attr( $this->table_name ) . '`.', 'wp-data-access' ) ;
        ...
        if ( isset( $settings_db_custom->hyperlinks ) && is_array( $settings_db_custom->hyperlinks ) ) {
            foreach ( $settings_db_custom->hyperlinks as $hyperlink ) {
                ...
                echo  esc_attr( $this->rownum ) ;
                ?>_add_hyperlink_<?php 
                echo  esc_attr( $no_hyperlinks ) ;
                ?>">
														<td style="padding-left:0;vertical-align:top;">
															<input id="<?php 
                echo  esc_attr( $this->rownum ) ;
                ?>_hyperlink_label_<?php 
                echo  esc_attr( $no_hyperlinks ) ;
                ?>"
                ...
                echo  sprintf( __( 'Delete hyperlink %s?', 'wp-data-access' ), esc_attr( $hyperlink_label ) ) ;
                ?>')) { jQuery('#wpda_<?php 
                echo  esc_attr( $this->rownum ) ;
                ?>_add_hyperlink_<?php 
                echo  esc_attr( $no_hyperlinks ) ;
											...
											>
												<td colspan="3" style="padding-left:0;">
													<a class="wpda_table_settings_add_menu" href="javascript:void(0);"
													   onclick="jQuery('#wpda_<?php 
        echo  esc_attr( $this->rownum ) ;
        ?>_add_hyperlink_link').hide(); jQuery('#wpda_<?php 
        echo  esc_attr( $this->rownum ) ;
        ?>_add_hyperlink').show();">
														&raquo; Add Hyperlink
													</a>
        ...
        ?></span>
									<a href="https://wpdataaccess.com/docs/documentation/data-explorer/dashboard-menus/" target="_blank">
										<span class="dashicons dashicons-editor-help wpda_tooltip"
											  title="<?php 
        echo  sprintf( __( 'Add table `%s` to a WordPress dashboard menu [help opens in a new tab or window]', 'wp-data-access' ), esc_attr( $this->table_name ) ) ;
        ?>"
											  style="cursor:pointer;vertical-align:text-bottom;"></span>
									</a>
									<ul class="wpda_table_settings_nested">
        ...
        foreach ( $table_menus as $table_menu ) {
            ?>
												<tr>
													<td style="padding-left:0;vertical-align:top;">
														<input id="menu_name_<?php 
            echo  esc_attr( $no_menus ) ;
            ?>"
            ...
            ?>
														...
														<a href="javascript:void(0)"
														   class="dashicons dashicons-trash"
														   onclick="if (confirm('<?php 
            echo  sprintf( __( 'Delete menu %s?', 'wp-data-access' ), esc_attr( $table_menu['menu_name'] ) ) ;
            ?>')) { jQuery('#<?php 
            echo  esc_attr( $this->rownum ) ;
            ?>_menu_id').val('<?php 
            echo  esc_attr( $table_menu['menu_id'] ) ;
            ?>'); jQuery('#<?php 
            echo  esc_attr( $delete_menu_table_form_id ) ;
            ?>').submit(); }"
														></a>
														<input id="menu_id_<?php 
            echo  esc_attr( $no_menus ) ;
            ?>"
            ...
            echo  esc_attr( $table_menu['menu_id'] ) ;
            ?>">
														<input id="menu_role_<?php 
            echo  esc_attr( $no_menus ) ;
            ?>_old" type="hidden"
															   value="<?php 
            echo  esc_attr( $table_menu['menu_role'] ) ;
            ?>">
													</td>
												</tr>
												<?php 
											...
											>
												<td colspan="3" style="padding-left:0;">
													<a class="wpda_table_settings_add_menu" href="javascript:void(0);"
													   onclick="jQuery('#wpda_<?php 
        echo  esc_attr( $this->rownum ) ;
        ?>_add_menu_link').hide(); jQuery('#wpda_<?php 
        echo  esc_attr( $this->rownum ) ;
        ?>_add_menu').show();">
														&raquo; Add menu
													</a>
        ...
        ?>',
							'<?php 
        echo  esc_attr( $settings_table_form_settings ) ;
        ?>',
							'<?php 
        echo  esc_attr( $settings_table_form_id ) ;
        ?>',
							'<?php 
        echo  esc_attr( $this->table_name ) ;
        ?>'
        ...
        ?>'
					...
					jQuery('#wpda_<?php 
        echo  esc_attr( $this->rownum ) ;
        ?>_cancel_hyperlinks').click( function() {
						jQuery('#wpda_admin_menu_actions_<?php 
        echo  esc_attr( $this->rownum ) ;
        ?>').toggle();
						wpda_toggle_row_actions('<?php 
        ...
        ?>'
					...
					jQuery('#wpda_<?php 
        echo  esc_attr( $this->rownum ) ;
        ?>_cancel_dashboard_menus').click( function() {
						jQuery('#wpda_admin_menu_actions_<?php 
        echo  esc_attr( $this->rownum ) ;
        ?>').toggle();
						wpda_toggle_row_actions('<?php 
